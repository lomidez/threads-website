...
namespace ContosoCrafts.WebSite.Models
{
    public class ProductModel
    {
        ...
        // Ratings should match JSON data type (if null, make it nullable int array)
        public int[] Ratings { get; set; } = new int[] { };

        public ProductTypeEnum ProductType { get; set; } = ProductTypeEnum.Undefined;

        // Update Quantity to nullable int if the JSON values are numbers
        ...
        // Store tags associated with this product
        public List<TagModel> Tags { get; set; } = new List<TagModel>();
        ...
        // Additional fields for Weight and Dimensions
        public decimal Weight { get; set; }

        public Dimensions Dimentions { get; set; } = new Dimensions();

        // ToString method to serialize the ProductModel
